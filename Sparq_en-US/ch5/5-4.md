...
TODO: revise the whole file later, it was migrated as-is from subnetooor/src/net/p2p/Encoding.md and not updated accordingly since then

This chapter descbires how P2P encoding works on SparqNet.
