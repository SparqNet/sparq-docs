...
* `ContractManager` is responsible for handling the ownership of all contracts registered within the blockchain, as well as their global variables (contract name, address, owner, balance, etc.) and emission of events
