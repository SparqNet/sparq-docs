...
Both constructors have to call `registerContractFunctions()` as well as `updateState(true)` at the end. Those will be explained further. The destructor is responsible for saving the current information within the contract back to the database.
