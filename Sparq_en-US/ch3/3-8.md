...
**Note 4**: The ABI needs to be a valid JSON ABI, not just an array as you might be used to. Make sure the key holding the ABI is labeled "abi". It should look something like this:
...
**Note 5**: If you are passing an array as input values, just separate them by commas, and the application will do all the necessary changes.
