...
Este é um "Rosetta Stone" das funções da classe Utils e como usá-las para facilitar a vida de quem estiver programando no Sparq.

* [Debugando por meio de print nos logs](#debugando-por-meio-de-print-nos-logs)
* [Conversão de tipos](#conversão-de-tipos)
* [StringContainer e seus aliases](#stringcontainer-e-seus-aliases)
...
Em vários pontos do Sparq, bytes puros (raw bytes) são usados ao invés de bytes em formato hexadecimal (hex string), porém ambos são tratados como `std::string`, o que pode ser confuso pra quem decidir printar um "string" e ver um monte de lixo ao invés de um "Hello World".
...
## StringContainer e seus aliases
...
Não existe bem um "padrão" de comportamento, mas o ideal é que se use os endereços sempre em **caixa baixa**, convertendo para outros tipos somente quando necessário.
